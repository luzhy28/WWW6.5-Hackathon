...
RescueLink 以单个**rescue case**为核心，为每一个case提供统一的信息入口和协作页面。
...
RescueLink希望让每一次流浪动物救助，从一个人在社交平台孤立求助，变成一次可以被看见、被接力、被追踪的协作过程。
...
它援 RescueLink希望让每一次流浪动物救助，从一个人的孤立求助，变成一次多方参与、责任清晰、贡献可见的协作过程。
